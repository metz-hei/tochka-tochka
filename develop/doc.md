...
[Где хранятся технические задания? Поддерживается ли их актуальность?](../develop/attachments/technicalTask.png)

Где ведется документация по API? Когда и кто документирует API?

Есть ли релизный чек-лист?

[Составляются ли тест-планы](./docTestPlan)?

[Пишутся ли тест-кейсы](./docTestCase)?
...
- Бэкенд (авторизация, поиск, логирование и т. д.)
- Фронтенд
